...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AProjectile()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_ProjectileDamage = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ProjectileDamage"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ProjectileDamage, AProjectile), 0x0040000000010001);
				...
				MetaData->SetValue(NewProp_ProjectileDamage, TEXT("Category"), TEXT("Setup"));
				MetaData->SetValue(NewProp_ProjectileDamage, TEXT("ModuleRelativePath"), TEXT("Public/Projectile.h"));
	...
	IMPLEMENT_CLASS(AProjectile, 2676668607);
